...
Finally, let's create a little helper function for formatting some results later on (essentially like `round()`, but does not drop trailing zeros).
...
Part of the code for this chapter is adapted from the chapter itself (see section 10.5). Below, we will make use of several additional packages that need to be installed (if they are not already installed). So let's do this first.
