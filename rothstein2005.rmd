...
```{r}
# fit fixed-effects model to dataset 2
...
```{r}
# fit fixed-effects model to dataset 1
...
```{r}
# fit fixed-effects model to dataset 3r
...
```{r}
# fit fixed-effects model to dataset 3z
...
#sav <- copas(res) # this generates an error at the moment; hopefully this problem can be fixed
#plot(sav)
#summary(sav)
```
